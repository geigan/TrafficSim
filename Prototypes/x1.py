...
class Light(object):
	...
	def DetermineState(self,StartsGreen,x): #to be defined/implemented. Determines current light based on starting cycle when cycle is advanced.
		if(StartsGreen):
...
class Instance(object):
	...
	#def Clock(z):
		for x in range(self.TotalCycles):
			...
			NS.DetermineState(True,x)
			EW.DetermineState(False,x)
